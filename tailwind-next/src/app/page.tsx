  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col">
        <div className="flex flex-col lg:flex-row justify-between lg:items-center pb-5 gap-4 border-b border-zinc-200 dark:border-zinc-700">
        ...
        <form
          id="settings"
          className="mt-6 flex flex-col w-full gap-5 divide-y divide-zinc-200 dark:divide-zinc-700" // divide é uma forma de criar linha abaixo para separar as divs dos elementos do formulário!
        >
